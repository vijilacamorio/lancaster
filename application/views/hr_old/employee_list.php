            ...
            <div class="panel panel-bd lobidrag"     style="border: 3px solid #d7d4d6;">
               <div class="panel-heading"  style="border-color:white;" >
                  <div class="row"   style="height:0px;">
                    ...
                    <option value="6"><?php echo ('Rate Type') ?></option>
...
<th class="6 value"  data-col="6"  data-resizable-column-id="6" ><?php echo  ('Rate Type') ?></th>
...
<td class="2 value"  data-col="2" style="text-align:center;" >  <?php echo html_escape($employees['first_name']).' '.html_escape($employees['last_name']);?></a></td>
...
<td class="11 value"  data-col="11">
    <?php if(empty($employees['profile_image'])){ ?> 
                                    ...
                                    <?php }else{ ?> 
                                       <img src="<?php  echo base_url(); ?>uploads/<?php echo $employees['profile_image']; ?>" height="60px" width="80px"></td>
                                    <?php } ?>
</td>
