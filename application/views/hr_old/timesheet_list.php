  ...
  <div id="search_area" style="border:4px solid #004d99;border-radius:7px;">
            ...
            <th class="search_dropdown" style="width: 22%;">
               ...
               <select id="pname-filter" class="form-control">
                  ...
                  <?php 
                     ...
                     $payment_term = array();
                     foreach ($timesheet_data_get as $time) {
                     $payment_term[] = $time['payment_term'];
                     }
   ...
   <table>
      <tr>
         ...
         <td style="width:22%;">   <input type="text" class="form-control" id="myInput1" onkeyup="search()" placeholder="Search for Employee Name.."></td>
         <td style="width:10px;"></td>
         <td style="width:22%;"> <input type="text" class="form-control" id="myInput2" onkeyup="search()" placeholder="Search for Duration.."></td>
         <td style="width:10px;"></td>
         <td style="width:20%;">  <input type="text" class="form-control" id="myInput3" onkeyup="search()" placeholder="Search for   Daily Break.."></td>
         <td style="width:10px;"></td>
         <td style="width:20%;"> <input type="text" class="form-control" id="myInput4" onkeyup="search()" placeholder="Search for   Payment Terms.."></td>
         <td style="width:10px;"></td>
         <td style="width: 203px;"> <input type="text" class="form-control" id="myInput5" onkeyup="search()" placeholder="Search for Month.."></td>
      </tr>
   </table>
   <br/>
   <div class="col-sm-12">
...
<tr id="task-<?php echo $i; ?>"
                                                class="task-list-row"
                                                  ...
                                                  data-unit="<?php echo $timsht['payment_term']; ?>"
...
<div id="myModal_colSwitch"  name="mytimesheetName"      class="modal_colSwitch" >
   <div class="modal-content_colSwitch" style="width:20%;height:20%;">
      ...
      <div class="col-sm-3" >
         <br>
         <div class="form-group row"  >
            <br><input type="checkbox"  data-control-column="5"    class="5" value="5"/>&nbsp;Daily Break<br>
