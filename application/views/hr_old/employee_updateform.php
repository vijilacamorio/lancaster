            ...
            <label for="address_line_2" class="col-sm-4 col-form-div"><?php echo display('address_line_2') ?></label>
               ...
               <input name="city" class="form-control" type="text" placeholder="<?php echo display('city') ?>" id="city" value="<?php echo html_escape($employee_data[0]['city']);?>">
                  ...
                  <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input name="state" class="form-control" type="text" placeholder="<?php echo display('state') ?>" id="state" value="<?php echo html_escape($employee_data[0]['state']);?>">
...
<div class="col-sm-8">
    <input class="form-control" name="emergencycontact" id="emergencycontact" type="text"  style="border:2px solid #D7D4D6;"   placeholder="Emergency Contact person" value="<?php echo html_escape($employee_data[0]['emergencycontact'])?>"  >
</div>
</div>
...
<div class="col-sm-8">
    <input class="form-control" name="emergencycontactnum" id="emergencycontactnum" type="number"  style="border:2px solid #D7D4D6;"   placeholder="Emergency Contact  number" value="<?php echo html_escape($employee_data[0]['emergencycontactnum'])?>"  >
</div>
</div>
            ...
            <div class="col-sm-6">
               ...
               <input name="sc" class="form-control" type="text" value="<?php echo html_escape($employee_data[0]['sc']);?>" placeholder="<?php echo 'sales commission' ?>"  >
                  ...
                  <div class="form-group row" id="payment_from">
                  <label for="payroll_type" class="col-sm-4 col-form-label"> Payroll Type </label>
                     <div class="col-sm-8">
                     ...
                     <div class="col-sm-8">
                        <input name="hrate" class="form-control" type="number" placeholder="<?php echo "Pay rate" ?>" id="hrate" value="<?php echo html_escape($employee_data[0]['hrate'])?>">
                     </div>
                  </div>
                  ...
                  <div class="form-group row">
               <label for="email" class="col-sm-4 col-form-div">Social security number</label>
               <div class="col-sm-8">
 ...
 <label for="zip" class="col-sm-4 col-form-div"><?php echo 'Account Number' ?></label>
         <div class="col-sm-8">
         <input type="text" name="account_number" class="form-control" value="<?php echo $employee_data[0]['account_number']; ?>">
 </div>
 </div>
 ...
 <div class="form-group row">
        ...
        <div class="row">
            <!-- Working Taxes -->
              <div class="col-sm-6">
                ...
                <div class="form-group fg" >
                    ...
                    <input list="magic_state_tax" name="state_tax" id="stateTaxDropdown"  value="<?php echo html_escape($employee_data[0]['state_tx'])?>"   class="form-control">
                ...
                <div class="form-group fg">
                    ...
                    <input list="magic_local_tax" name="city_tax" id="localTaxDropdown"  value="<?php echo html_escape($employee_data[0]['local_tax'])?>"    class="form-control">
                ...
                <div class="form-group fg">
                    ...
                    <input list="magic_state_local_tax" name="county_tax" id="stateLocalTaxDropdown"  value="<?php echo html_escape($employee_data[0]['cty_tax'])?>"   class="form-control">
                ...
                <div class="form-group fg">
                    ...
                    <input list="magic_state_tax_2" name="other_working_tax" id="stateTax2Dropdown"   value="<?php echo html_escape($employee_data[0]['state_tax_1'])?>"  class="form-control">
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group fg">
                    ...
                    <input list="magic_living_state_tax" name="living_state_tax"  value="<?php echo html_escape($employee_data[0]['living_state_tax'])?>"    id="livingStateTax" class="form-control">
                ...
                <div class="form-group fg">
                    ...
                    <input list="magic_living_city_tax" name="living_city_tax" id="livingCityTax"  value="<?php echo html_escape($employee_data[0]['living_local_tax'])?>"   class="form-control">
                ...
                <div class="form-group fg">
                    ...
                    <input list="magic_living_county_tax" name="living_county_tax" id="livingCountyTax"   value="<?php echo html_escape($employee_data[0]['living_county_tax'])?>"      class="form-control">
                ...
                <div class="form-group fg">
                    ...
                    <input list="magic_living_other_tax" name="other_living_tax" id="livingOtherTax"  value="<?php echo html_escape($employee_data[0]['state_tax_2'])?>"   class="form-control">
    ...
    <br>
     <div style='float:right;font-weight:bold;'>
        ...
        <button type="button"  style="background-color:green;margin-left: 335px;width:60px;" class="btn btnclr"   id="addPopupData">Add</button>
...
<div class="form-group row">
    ...
    <div class="col-sm-8">
       <button type="button" class="btnclr btn" id="showPopup">Add Withholding Tax</button>
                  ...
                  <br>
                  <button type="submit" style="float:center;color:white;" class="btnclr btn  w-md m-b-5"><?php echo display('save') ?></button>
                  <?php echo form_close() ?>
               </div>
            </div>
         </div>
