...
--->
     <div class="landscape-box">
      ...
      <a href="<?php  echo base_url() ?>/assets/fw4.pdf" download="W4 Form">
      <!-- <img class="circular_image" src="<?php  echo base_url()?>assets/images/W4.jpg"   alt = "Rounded Image" width = "200" height = "200"/> -->
        <br>
      <strong><span style="bottom:10px;" class="s_name">W 4 Form</span></strong>
    <div class="div">  <strong>Disclaimer :<br/>
      Please Check IRS Website for the Current and Updated W4 Form. </strong>
</div>
     <br>
</a>
    </div>
         ...
         <div class="landscape-box">
       <a href="<?php  echo base_url() ?>/assets/fw9.pdf" download="W9 Form">
      
      <!-- <img class="circular_image" src="<?php  echo base_url()?>assets/images/W4.jpg"   alt = "Rounded Image" width = "200" height = "200"/> -->
        <br>
      <strong><span style="bottom:10px;" class="nname">W 9 Form</span></strong>
    <!-- <div class="div">  Disclaimer :<br/>
      Please Check IRS Website for the Current and Updated W4 Form. 
</div> -->
     <br>
         ...
         <div class="landscape-box">
       <a href="<?php  echo base_url() ?>/assets/walkin" download="W9 Form">
      
      <!-- <img class="circular_image" src="<?php  echo base_url()?>assets/images/W4.jpg"   alt = "Rounded Image" width = "200" height = "200"/> -->
        <br>
      <strong><span style="bottom:10px;" class="nname">Walkin Application Form</span></strong>
    <!-- <div class="div">  Disclaimer :<br/>
      Please Check IRS Website for the Current and Updated W4 Form. 
</div> -->
     <br>
         ...
         <div class="landscape-box hand_book">
           <a href="#" >
      ...
      <!-- <img class="circular_image" src="<?php  echo base_url()?>assets/images/W4.jpg"   alt = "Rounded Image" width = "200" height = "200"/> -->
        <br>
      <strong><span style="bottom:10px;" class="nname">Employee Hand Book</span></strong>
    <!-- <div class="div">  Disclaimer :<br/>
      Please Check IRS Website for the Current and Updated W4 Form. 
</div> -->
     <br>
...
<script>
    ...
    mouseenter: function () {
      ...
      $(this).find('.s_name').hide();
    },
    mouseleave: function () {
        $(this).find('.s_name').show();
    }
});
...
$(document).ready(function()
    ...
    }).set(opt).from(clonedElement).save();  
   // $('#content').hide();
