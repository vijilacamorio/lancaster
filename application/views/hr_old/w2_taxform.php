      ...
      <html xmlns="http://www.w3.org/1999/xhtml" lang="" xml:lang="">
         ...
         <body bgcolor="#A0A0A0" vlink="blue" link="blue">
            <div id="page2-div" style="position:relative;width:918px;height:1188px;    margin-left: 300px;">
               ...
               <p style="position:absolute;top:416px;left:63px;white-space:nowrap" class="ft23"><b>f &#160;</b>Employee’s address and ZIP code <br><span style="color: #000; font-size: 14px; position: absolute; bottom: 18px;"><?php echo $getlocation[0]['address']; ?></span></p>
               ...
               <?php
                  $overalltotal_amount = isset($get_payslip_info[0]['ftotal_amount']) ? round($get_payslip_info[0]['ftotal_amount'], 2) : '0';
                   ?>
               ...
               <p style="position:absolute;top:164px;left:508px;white-space:nowrap" class="ft23"><b>5 &#160;&#160;</b>Medicare wages and tips <br><span style="color: #000; font-size: 14px;font-size: 14px;"><?php
                  $t_tax = isset($get_payslip_info[0]['overalltotal_amount']) ? $get_payslip_info[0]['overalltotal_amount']: 0;
               ...
               <p style="position:absolute;top:344px;left:503px;white-space:nowrap" class="ft23"><b>14 &#160;</b>Other
                <br>
                  ...
                  <span>
                  <?php echo ($tax_info['tax']); ?>  -  <?php echo $tax_info['amount']?>    <br>
                  </span>
                  <?php  endforeach; ?>
               ...
               <?php
                  $overalltotal_statetax = isset($stateTax[0]['overalltotal_statetax']) ? round($stateTax[0]['overalltotal_statetax'], 2) : '0';
                  ?>
               <?php
                  $overalltotal_statetaxworking = isset($stateworkingtax[0]['overalltotal_statetaxworking']) ? round($stateworkingtax[0]['overalltotal_statetaxworking'], 2) : '0';
                  ?>
               ...
               <?php
                  $overalltotal_localtax = isset($localTax[0]['overalltotal_localtax']) ? round($localTax[0]['overalltotal_localtax'], 2) : '0';
                  ?>
               <?php
                  $livinglocaltax = isset($livinglocaldata[0]['livinglocaltax']) ? round($livinglocaldata[0]['livinglocaltax'], 2) : '0';
                  ?>
      ...
      <html xmlns="http://www.w3.org/1999/xhtml" lang="" xml:lang="">
         ...
         <body bgcolor="#A0A0A0" vlink="blue" link="blue">
            <div id="page3-div" style="position:relative;width:918px;height:1188px;    margin-left: 300px;">
               ...
               <p style="position:absolute;top:416px;left:63px;white-space:nowrap" class="ft32"><b>f &#160;</b>Employee’s address and ZIP code <br><span style="color: #000; font-size: 14px; position: absolute; bottom: 18px;"><?php echo $getlocation[0]['address']; ?></span></p>
...
<?php echo !empty($matchedCode) ? htmlspecialchars($c_details[0]['State_Tax_ID_Number'], ENT_QUOTES, 'UTF-8') : ''; ?>
               ...
               <p style="position:absolute;top:434px;left:793px;white-space:nowrap" class="ft32"><b>20 &#160;</b>Locality name <br> 
                  ...
                  <br>
                  <span style="color: black;font-size: large;font-size: 14px;position: relative;top: 9px;"> 
                  <?php echo htmlspecialchars($matchedCode2, ENT_QUOTES, 'UTF-8'); ?>  
                  </span>
               </p>
      ...
      <html xmlns="http://www.w3.org/1999/xhtml" lang="" xml:lang="">
         ...
         <body bgcolor="#A0A0A0" vlink="blue" link="blue">
            <div id="page4-div" style="position:relative;width:918px;height:1188px;    margin-left: 300px;">
               ...
               <p style="position:absolute;top:416px;left:63px;white-space:nowrap" class="ft41"><b>f &#160;</b>Employee’s address and ZIP code <br><span style="color: #000; font-size: 14px; position: absolute; bottom: 18px;"><?php echo $getlocation[0]['address']; ?></span></p>
      ...
      <html xmlns="http://www.w3.org/1999/xhtml" lang="" xml:lang="">
         ...
         <body bgcolor="#A0A0A0" vlink="blue" link="blue">
            <div id="page6-div" style="position:relative;width:918px;height:1188px;     margin-left: 300px;">
               ...
               <p style="position:absolute;top:416px;left:63px;white-space:nowrap" class="ft61"><b>f &#160;</b>Employee’s address and ZIP code <br><span style="color: #000; font-size: 14px; position: absolute; bottom: 18px;"><?php echo $getlocation[0]['address']; ?></span></p>
      ...
      <html xmlns="http://www.w3.org/1999/xhtml" lang="" xml:lang="">
         ...
         <body bgcolor="#A0A0A0" vlink="blue" link="blue">
            <div id="page8-div" style="position:relative;width:918px;height:1188px;     margin-left: 300px;">
               ...
               <p style="position:absolute;top:416px;left:63px;white-space:nowrap" class="ft81"><b>f &#160;</b>Employee’s address and ZIP code  <br><span style="color: #000; font-size: 14px; position: absolute; bottom: 18px;"><?php echo $getlocation[0]['address']; ?></span></p>
      ...
      <html xmlns="http://www.w3.org/1999/xhtml" lang="" xml:lang="">
         ...
         <body bgcolor="#A0A0A0" vlink="blue" link="blue">
            <div id="page10-div" style="position:relative;width:918px;height:1188px;     margin-left: 300px;">
               ...
               <p style="position:absolute;top:416px;left:63px;white-space:nowrap" class="ft102"><b>f &#160;</b>Employee’s address and ZIP code <br><span style="color: #000; font-size: 14px; position: absolute; bottom: 18px;"><?php echo $getlocation[0]['address']; ?></span></p>
