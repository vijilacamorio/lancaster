...
<?php
$employee_count = isset($get_total_customersData[0]['employee_count']) ? $get_total_customersData[0]['employee_count'] : 'Default Name';
?>
...
<?php
$Federal_Pin_Number = isset($get_cominfo[0]['Federal_Pin_Number']) ? $get_cominfo[0]['Federal_Pin_Number'] : 'Default Name';
?>
...
<?php
$State_Tax_ID_Number = isset($get_cominfo[0]['State_Tax_ID_Number']) ? $get_cominfo[0]['State_Tax_ID_Number'] : 'Default Name';
?>
...
<p style="position:absolute;top:451px;left:231px;white-space:nowrap" class="ft22"><b>17</b>&#160;State income tax <br> <span style="color: black;font-size: large;">$<?php echo htmlspecialchars($overalltotal_statetax, ENT_QUOTES, 'UTF-8'); ?></span> </p>
...
<?php
$mobile = isset($get_cominfo[0]['mobile']) ? $get_cominfo[0]['mobile'] : 'Default Address';
 ?>
 <?php
$username = isset($get_employer_federaltax[0]['username']) ? $get_employer_federaltax[0]['username'] : 'Default Address';
 ?>
<p style="position:absolute;top:487px;left:72px;white-space:nowrap" class="ft23">Employer’s contact person  <br> <span style="color: black;font-size: large;"> <?php echo htmlspecialchars($username, ENT_QUOTES, 'UTF-8'); ?></p>
...
<?php
$email = isset($get_employer_federaltax[0]['email_id']) ? $get_employer_federaltax[0]['email_id'] : 'Default email';
 ?>
