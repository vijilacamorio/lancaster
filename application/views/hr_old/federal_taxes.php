                        ...
                        border-collapse:collapse;'>
                                  ...
                                  <th style='text-align:center;'>".display('sl')."</th>
                                       ...
                                       for ($i = 0; $i < sizeof($states_list); $i++) {
                                           ...
                                           echo "<tr><td style='text-align:center;' >".$k."</td><td class='state_name' style='text-align:center;font-weight:bold;' rowspan='".$j."'>". $states_list[$i]['state']."</td> <td><table>";
                                   
                                           foreach ($splt as $sp) {
                                               if (!empty($sp) && $sp !== ',') {
                                                   $sp_url = str_replace(" "," ", $sp);
                                                   echo "<tr><td style='display:none' class='state_name'>". $states_list[$i]['state']."</td><td style='width:450px;' class='tax_value'>".$sp."</td> <td>  <a  href=".base_url('Chrm/add_state_taxes_detail?tax='.urlencode($states_list[$i]['state'])."-".urlencode($sp_url))." class='btn btnclr btn-sm' data-toggle='tooltip' data-placement='left'  data-original-title='Add Taxes Detail'><i class='fa fa-window-restore' aria-hidden='true'></i></a>
                     ...
                     <?php 
                        ...
                        border-collapse:collapse;'>
                                     ...
                                     <th style='text-align:center;'>".display('sl')."</th>
                                           ...
                                           <th style='width:50%; text-align: left;'>City Taxes</th>
                                 ...
                                 for($i=0; $i < sizeof($city_list); $i++) {
                                       ...
                                       //  <input style='text-align:center' type='checkbox' ". (($city_list[$i]['state']==$city_list[0]['state'])? ' checked ':''). "value=".urlencode($city_list[$i]['state'])." class='checkbox_id' >".$k."</td><td class='state_name' style='text-align:center;font-weight:bold;' rowspan='".$j."'>". $city_list[$i]['state']."</td> 
                                        
                                       //  <td><table>";
                                       

                                        echo "<tr><td style='text-align:center;' >".$k."</td><td class='citystate_name' style='text-align:center;font-weight:bold;' rowspan='".$j."'>". $city_list[$i]['state']."</td> <td><table>";
                                     ...
                                     if(!empty($sp) && $sp !==','){
                                   $sp_url= str_replace(" "," ",$sp);
                                   echo "<tr><td style='display:none' class='citystate_name'>". $city_list[$i]['state']."</td><td style='width:450px;' class='citytax_value'>".$sp."</td> <td>  <a  href=".base_url('Chrm/add_state_taxes_detail?tax='.urlencode($city_list[$i]['state'])."-".urlencode($sp_url))." class='btn btnclr btn-sm' data-toggle='tooltip' data-placement='left'  data-original-title='Add Taxes Detail'><i class='fa fa-window-restore' aria-hidden='true'></i></a>
                     ...
                     <?php 
                        ...
                        border-collapse:collapse;'>
                                     ...
                                     <th style='text-align:center;'>".display('sl')."</th>
                                           ...
                                           <th style='width:50%; text-align: left;'>County Taxes</th>
                                 ...
                                 for($i=0; $i < sizeof($county_list); $i++) {
                                        ...
                                        echo "<tr><td style='text-align:center;' >".$k."</td><td class='county_name' style='text-align:center;font-weight:bold;' rowspan='".$j."'>". $county_list[$i]['state']."</td> <td><table>";

                                        foreach($splt as $sp){
                                 
                                     if(!empty($sp) && $sp !==','){
                                   $sp_url= str_replace(" "," ",$sp);
                                   echo "<tr><td style='display:none' class='county_name'>". $county_list[$i]['state']."</td><td style='width:450px;' class='countytax_value'>".$sp."</td> <td>  <a  href=".base_url('Chrm/add_state_taxes_detail?tax='.urlencode($county_list[$i]['state'])."-".urlencode($sp_url))." class='btn btnclr btn-sm' data-toggle='tooltip' data-placement='left'  data-original-title='Add Taxes Detail'><i class='fa fa-window-restore' aria-hidden='true'></i></a>
