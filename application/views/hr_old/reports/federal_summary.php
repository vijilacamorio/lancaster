<?php error_reporting(1);  ?> <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css" />
<script type="text/javascript" src="
   <?php echo base_url()?>assets/js/jquery.base64.js"></script>
<script type="text/javascript" src="
   <?php echo base_url()?>assets/js/drag_drop_index_table.js"></script>
<script type="text/javascript" src="
   <?php echo base_url()?>assets/js/html2canvas.js"></script>
<script type="text/javascript" src="
   <?php echo base_url()?>assets/js/jspdf.plugin.autotable"></script>
<script type="text/javascript" src="
   <?php echo base_url()?>assets/js/jspdf.umd.js"></script>
<script type="text/javascript" src="//cdn.jsdelivr.net/momentjs/latest/moment.min.js"></script>
<script type="text/javascript" src="
   <?php echo base_url()?>my-assets/js/invoice_tableManager.js"></script>
<link rel="stylesheet" type="text/css" href="//cdn.jsdelivr.net/bootstrap/3/css/bootstrap.css" />
<!--<script type="text/javascript" src="//cdn.jsdelivr.net/bootstrap.daterangepicker/2/daterangepicker.js"></script>-->
<!--<link rel="stylesheet" type="text/css" href="//cdn.jsdelivr.net/bootstrap.daterangepicker/2/daterangepicker.css" />-->
<!-- <script type="text/javascript" src="
   <?php echo base_url()?>my-assets/js/tableManager.js"></script> -->
...
<script src="
   <?php echo base_url() ?>assets/js/dashboard.js"></script>
...
<link rel="stylesheet" href="
   <?php echo base_url() ?>my-assets/css/style.css">
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
<script type="text/javascript" src="http://www.bacubacu.com/colresizable/js/colResizable-1.5.min.js"></script>
<link rel="stylesheet" type="text/css" href="
   <?php echo base_url()?>my-assets/css/css.css" />
<input type="hidden" name="
   <?php echo $this->security->get_csrf_token_name();?>" value="
   <?php echo $this->security->get_csrf_hash();?>">
<link rel="stylesheet" type="text/css" href="
...
<style>
   .btnclr {
   background-color:
   <?php echo $setting_detail[0]['button_color'];
      ?>;
   color: white;
   }
   .table td {
...
<div class="content-wrapper">
      ...
      <div class="row">
         <div class="col-sm-16 col-md-14">
            <div class="panel panel-bd lobidrag" style='height:80px; border: 3px solid #d7d4d6;'>
                     ...
                     <table class="table" align="center" style="overflow-x: unset;position: relative; left: 150px;">
                        <tr style='text-align:center;font-weight:bold;' class="filters">
                           ...
                           <td class="search_dropdown" style="width: 15%; color: black;">
                              <input type="hidden" class="txt_csrfname" name="
                                 <?= $this->security->get_csrf_token_name(); ?>" value="
                              ...
                              <select id="customer-name-filter" name="employee_name" class="form-control">
                                 ...
                                 <?php
                                    ...
                                    ?> 
                                 <option value="
                                    <?php echo $emp['first_name']." ".$emp['last_name']; ?>"> <?php echo $emp['first_name']." ".$emp['last_name']; ?> </option>
                                 <?php } ?>
                              </select>
                           </td>
                           <td class="search_dropdown" style="width: 15%; color: black;">
               ...
               <span class="fa fa-download"></span> <?php echo display('download') ?> </button>
               <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
               <li>
               <a href="#" onclick="generate()">
               <img src="
                  <?php echo base_url() ?>assets/images/pdf.png" width="24px"> <?php echo display('PDF') ?> </a>
               </li>
               <li class="divider"></li>
               <li>
               <a href="#" onclick="$('#ProfarmaInvList').tableExport({type:'excel',escape:'false'});">
               <img src="
                  <?php echo base_url() ?>assets/images/xls.png" width="24px"> <?php echo display('XLS') ?> </a>
               </li>
               </ul> &nbsp; &nbsp; &nbsp; <button type="button" class="btnclr btn btn-default dropdown-toggle" onclick="printDiv('printableArea')">
               <b class="ti-printer"></b>&nbsp; <?php echo display('print') ?> </button>
               </div>
               </div>
            </div>
         </div>
                        ...
                        <table class="table table-bordered" cellspacing="0" width="100%" id="ProfarmaInvList">
                           <thead class="sortableTable">
                              <tr class="sortableTable__header btnclr">
                                 ...
                                 <th rowspan="2" class="8 value" data-col="8" style="text-align:center;"> <?php echo 'Status';?> </th>
                              </tr>
                              <tr>
                           ...
                           <tbody class="sortableTable__body" id="tab">
                              ...
                              <tr>
                                 ...
                                 <td> <?php echo  $f_tax['f_ftax']; ?> </td>
                                 <td> <?php if($f_tax['ftax']){echo  $f_tax['ftax']; }else{echo '0';}?> </td>
                                 <td> <?php echo  $f_tax['s_stax']; ?> </td>
                                 <td> <?php if($f_tax['stax']){echo  $f_tax['stax']; }else{echo '0';}?> </td>
                                 <td> <?php echo  $f_tax['m_mtax']; ?> </td>
                                 <td> <?php if($f_tax['mtax']){echo  $f_tax['mtax']; }else{echo '0';}?> </td>
                                 <td> <?php echo  $f_tax['u_utax']; ?> </td>
                                 <td> <?php if($f_tax['utax']){echo  $f_tax['utax']; }else{echo '0';}?> </td>
                           ...
                           <tfoot>
                              <?php
                                 ...
                                 foreach($fed_tax as $f_tax) {
                                     $employeeContributionTotal_f += $f_tax['f_ftax'];
                                     $employerContributionTotal_ff += ($f_tax['ftax']) ? $f_tax['ftax'] : 0;
                                 }
                                   $employeeContributionTotal_s = 0;
                                 $employerContributionTotal_ss = 0;
                                 
                                 foreach($fed_tax as $f_tax) {
                                     $employeeContributionTotal_s += $f_tax['s_stax'];
                                     $employerContributionTotal_ss += ($f_tax['stax']) ? $f_tax['stax'] : 0;
                                 }
                                   $employeeContributionTotal_m = 0;
                                 $employerContributionTotal_mm = 0;
                                 
                                 foreach($fed_tax as $f_tax) {
                                     $employeeContributionTotal_m += $f_tax['m_mtax'];
                                     $employerContributionTotal_mm += ($f_tax['mtax']) ? $f_tax['mtax'] : 0;
                                 }
                                   $employeeContributionTotal_u = 0;
                                 $employerContributionTotal_uu = 0;
                                 
                                 foreach($fed_tax as $f_tax) {
                                     $employeeContributionTotal_u += $f_tax['u_utax'];
                                     $employerContributionTotal_uu += ($f_tax['utax']) ? $f_tax['utax'] : 0;
                                 }
                                 ?> 
                              <tr>
                                 <td colspan="5"></td>
                                 <td> <?php echo $employeeContributionTotal_f; ?> </td>
                                 <td> <?php echo $employerContributionTotal_ff; ?> </td>
                                 <td> <?php echo $employeeContributionTotal_s; ?> </td>
                                 <td> <?php echo $employerContributionTotal_ss; ?> </td>
                                 <td> <?php echo $employeeContributionTotal_m; ?> </td>
                                 <td> <?php echo $employerContributionTotal_mm; ?> </td>
                                 <td> <?php echo $employeeContributionTotal_u; ?> </td>
                                 <td> <?php echo $employerContributionTotal_uu; ?> </td>
                                 <td colspan="1"></td>
                              </tr>
                           </tfoot>
                        </table>
   ...
   <script src="
      <?php echo base_url()?>assets/js/jquery.bootgrid.min.js"></script>
   ...
   <script src="
      <?php echo base_url() ?>my-assets/js/script.js"></script>
   <!--<script type="text/javascript" src="
      <?php echo base_url()?>my-assets/js/profarma.js"></script>-->
   <script src="
      <?php echo base_url() ?>my-assets/js/script.js"></script>
   <script src="
      <?php echo base_url()?>assets/js/jquery.bootgrid.min.js"></script>
     ...
     $.ajax({
       ...
       success: function(data) {
         ...
         data.forEach(function(item) {
           ...
           row += " < td style = 'text-align: center;' > " + item.first_name+"
           "+item.last_name + " < /td>";
