...
<tbody>
 ...
 <td class="paddin5ps"><button type="button" id="delPOIbutton" class="btnclr btn btn-danger"  value="Delete" onclick="deleteTaxRow(this)"><i class="fa fa-trash"></i></button></td>
