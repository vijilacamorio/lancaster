...
<script>
    document.getElementById('timesheetSelect').addEventListener('change', function() {
        ...
        window.location.href = link; // Redirect to the new URL
                            ...
                            <!--<a class="btnclr btn" href="<?php //echo base_url('chrm/w9form') ?>">W9 Form</a>-->
...
<script>
    document.getElementById('form941').addEventListener('change', function() {
        ...
        window.location.href = link; // Redirect to the new URL
                            ...
                            <a class="btnclr btn" href="<?php echo base_url('chrm/form1099nec') ?>">1099NEC Form</a>
                            <a class="btnclr btn" href="<?php echo base_url('chrm/formnj927') ?>">NJ927 Form</a>
    ...
    <?php 
    $addedIds = []; // Array to keep track of IDs that have been added
    foreach ($get_data_salespartner as $sales) {
